...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_1.png" alt="merge_1" width="454" height="154" class="alignnone size-full wp-image-2871" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_1.png 454w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_1-300x101.png 300w" sizes="(max-width: 454px) 100vw, 454px" />][1]
...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_2.png" alt="merge_2" width="442" height="162" class="alignnone size-full wp-image-2870" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_2.png 442w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_2-300x109.png 300w" sizes="(max-width: 442px) 100vw, 442px" />][2]

Second, the resolver should be set to a business logic handler that we will create.

[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_3.png" alt="merge_3" width="518" height="359" class="alignnone size-full wp-image-2869" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_3.png 518w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_3-300x207.png 300w" sizes="(max-width: 518px) 100vw, 518px" />][3]
...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_4.png" alt="merge_4" width="294" height="136" class="alignnone size-full wp-image-2868" />][4]
...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_5.png" alt="merge_5" width="624" height="157" class="alignnone size-full wp-image-2867" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_5.png 624w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_5-300x75.png 300w" sizes="(max-width: 624px) 100vw, 624px" />][5]
...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_6.png" alt="merge_6" width="728" height="182" class="alignnone size-full wp-image-2866" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_6.png 728w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_6-300x75.png 300w" sizes="(max-width: 728px) 100vw, 728px" />][6]
...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_7.png" alt="merge_7" width="624" height="66" class="alignnone size-full wp-image-2874" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_7.png 624w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_7-300x31.png 300w" sizes="(max-width: 624px) 100vw, 624px" />][7]
...
[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_8.png" alt="merge_8" width="624" height="352" class="alignnone size-full wp-image-2873" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_8.png 624w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_8-300x169.png 300w" sizes="(max-width: 624px) 100vw, 624px" />][8]

Click Start and wait for the process to complete.
  
Once synchronization is completed, we can review the dbo.PersonAudit table and the Person.Person table

[<img src="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_9.png" alt="merge_9" width="624" height="216" class="alignnone size-full wp-image-2872" srcset="http://blogs.ltd.local/wp-content/uploads/2014/07/merge_9.png 624w, http://blogs.ltd.local/wp-content/uploads/2014/07/merge_9-300x103.png 300w" sizes="(max-width: 624px) 100vw, 624px" />][9]
...
Taking advantage of the features natively available in SQL Server is an extremely effective way to accomplish tasks that may be nicely packaged in other features, simply not available to the edition or configurations. We’ve shown a great way of managing Merge Replication in a data audit solution just for this concept. Keep in mind, edition costs and other blocking events may cause you to not have access to features such as CDC but, there are many other features that provide much functionality far and beyond what they may seem to have on the surface.
 ...
 [1]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_1.png
 [2]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_2.png
 [3]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_3.png
 [4]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_4.png
 [5]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_5.png
 [6]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_6.png
 [7]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_7.png
 [8]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_8.png
 [9]: http://blogs.ltd.local/wp-content/uploads/2014/07/merge_9.png