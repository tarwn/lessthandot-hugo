...
<pre>CREATE TABLE [dbo].[tuning_example](
...
<pre>SELECT seed FROM tuning_example</pre>
...
<pre>SELECT col1,seed FROM tuning_example
WHERE col2 &gt;= 30 And col2 &lt;= 500</pre>
