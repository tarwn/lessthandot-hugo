...
[<img class="aligncenter size-full wp-image-4947" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-1.png" alt="subscription 1" width="573" height="460" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-1.png 573w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-1-300x240.png 300w" sizes="(max-width: 573px) 100vw, 573px" />][1]

Distribution Agent Location – select Run all agents at the Distributor (push subscriptions). Click Next.

[<img class="aligncenter size-full wp-image-4948" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-2.png" alt="subscription 2" width="576" height="456" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-2.png 576w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-2-300x237.png 300w" sizes="(max-width: 576px) 100vw, 576px" />][2]

Subscribers – here we will add the SQL DB. Click Add Subscriber > Add SQL Server Subscriber.

[<img class="aligncenter size-full wp-image-4949" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-3.png" alt="subscription 3" width="569" height="455" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-3.png 569w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-3-300x239.png 300w" sizes="(max-width: 569px) 100vw, 569px" />][3]
...
[<img class="aligncenter size-full wp-image-4950" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-4.png" alt="subscription 4" width="493" height="525" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-4.png 493w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-4-281x300.png 281w" sizes="(max-width: 493px) 100vw, 493px" />][4]
...
[<img class="aligncenter size-full wp-image-4951" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-5.png" alt="subscription 5" width="575" height="454" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-5.png 575w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-5-300x236.png 300w" sizes="(max-width: 575px) 100vw, 575px" />][5]

Distribution Agent Security – click the ellipses on the right side.

[<img class="aligncenter size-full wp-image-4952" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-6.png" alt="subscription 6" width="569" height="459" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-6.png 569w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-6-300x242.png 300w" sizes="(max-width: 569px) 100vw, 569px" />][6][
...
[<img class="aligncenter size-full wp-image-4953" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-7.png" alt="subscription 7" width="553" height="677" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-7.png 553w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-7-245x300.png 245w" sizes="(max-width: 553px) 100vw, 553px" />][7]

Click Next.

Synchronization Schedule – choose Run continuously. Click Next.

[<img class="aligncenter size-full wp-image-4954" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-8.png" alt="subscription 8" width="572" height="453" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-8.png 572w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-8-300x237.png 300w" sizes="(max-width: 572px) 100vw, 572px" />][8]

Initialize Subscriptions – make sure Initialize is checked, choose Immediately. Click Next.

[<img class="aligncenter size-full wp-image-4955" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-9.png" alt="subscription 9" width="576" height="451" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-9.png 576w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-9-300x234.png 300w" sizes="(max-width: 576px) 100vw, 576px" />][9]

Wizard Actions – select both options. Click Next.

[<img class="aligncenter size-full wp-image-4956" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-10.png" alt="subscription 10" width="573" height="454" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-10.png 573w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-10-300x237.png 300w" sizes="(max-width: 573px) 100vw, 573px" />][10]

Script File Properties – give the file a name. Review the other options. Click Next.

[<img class="aligncenter size-full wp-image-4957" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-11.png" alt="subscription 11" width="579" height="451" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-11.png 579w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-11-300x233.png 300w" sizes="(max-width: 579px) 100vw, 579px" />][11]

Click Finish. All steps should have a green checkmark next to them.

[<img class="aligncenter size-full wp-image-4958" src="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-12.png" alt="subscription 12" width="573" height="456" srcset="http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-12.png 573w, http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-12-300x238.png 300w" sizes="(max-width: 573px) 100vw, 573px" />][12]
...
Your replication subscriber is now set up. The next step is to verify that all the pieces work by testing both replication and AG failover.
 ...
 [1]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-1.png
 [2]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-2.png
 [3]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-3.png
 [4]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-4.png
 [5]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-5.png
 [6]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-6.png
 [7]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-7.png
 [8]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-8.png
 [9]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-9.png
 [10]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-10.png
 [11]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-11.png
 [12]: http://blogs.ltd.local/wp-content/uploads/2016/12/subscription-12.png