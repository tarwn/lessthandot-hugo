...
FROM [HumanResources].[Employee] a
	...
	ON b.[BusinessEntityID] = a.[BusinessEntityID]</pre>
...
FROM [HumanResources].[Employee] e
	...
	ON e.[BusinessEntityID] = p.[BusinessEntityID]</pre>
...
FROM [HumanResources].[Employee] emp
	...
	ON emp.[BusinessEntityID] = ps.[BusinessEntityID]</pre>
...
SELECT *
FROM fn_listextendedproperty('TableAlias', 'schema', 'Person', 'table', 'Address', NULL, NULL)</pre>
